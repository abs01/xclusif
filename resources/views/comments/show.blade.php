...
<div class="container mx-auto py-8">
    <header class="bg-white shadow">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <h1 class="text-2xl font-bold">Detalles del Comentario</h1>
        </div>
    </header>
    ...
    <div class="bg-white shadow-md rounded-lg p-8 mt-6">
        <div class="mb-6">
            ...
            <p class="text-gray-700">
                @if($comments->user)
                    <a href="{{ route('userCRUD.show', $comments->user->id) }}" class="text-blue-500 hover:underline">
        ...
        <div class="mb-6">
            ...
            <p class="text-gray-700">
                @if($comments->post)
                    <a href="{{ route('postCRUD.show', $comments->post->id) }}" class="text-blue-500 hover:underline">
                        {{ substr($comments->post->content, 0, 100) }}...
                    </a>
                @else
                    <span class="text-gray-500">N/A</span>
                @endif
