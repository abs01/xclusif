...
@section('content')
    <div class="container mx-auto py-8 max-w-2xl">
        ...
        {{-- Formulario eliminar imagen FUERA del form principal --}}
        @if ($sponsor->file_path)
            <div class="bg-white rounded-lg shadow-md p-4 mb-4 flex items-center gap-4">
                <img src="{{ asset('images/' . $sponsor->file_path) }}" alt="Imagen actual"
                    class="h-24 w-auto rounded">
                <form action="{{ route('sponsorCRUD.destroyImage', $sponsor) }}" method="POST"
        ...
        <div class="bg-white rounded-lg shadow-md p-8">
            <form action="{{ route('sponsorCRUD.update', $sponsor) }}" method="POST" class="space-y-6"
                ...
                <div class="flex gap-4 pt-6">
                    ...
                    <a href="{{ route('sponsorCRUD.show', $sponsor) }}"
